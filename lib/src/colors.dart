...
/// Design tokens for Annotter UI (Primitives, Neutrals, Chromatics 50-950).
/// Pure Flutter SDK with zero external dependencies.
class AnnotterColors {
  ...
  // Preset Marker Colors selectable in Settings
